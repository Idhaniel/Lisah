        ...
        <div className="flex-grow flex flex-col justify-between p-4">
          ...
          <div className="flex-grow flex flex-col items-center justify-center text-center">
            ...
            <p className="text-white/80 text-base font-normal leading-relaxed px-4 pb-3 max-w-sm">
              With our top-tier security protocols, including advanced
              encryption, your investments are always safe. The intuitive and
              user-friendly interface makes navigating the world of investing
